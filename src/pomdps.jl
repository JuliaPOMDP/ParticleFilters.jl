...
# WeightedParticleBelief with right number => passthrough
# ParticleCollection with right number => Create WeightedParticleBelief
# AbstractParticleBelief with wrong number => low var resample
# Other distribution => below
